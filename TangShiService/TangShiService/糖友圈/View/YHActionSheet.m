...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier{
    if (self = [super initWithStyle:style reuseIdentifier:reuseIdentifier]) {
        ...
        UILabel *labelTitle = [[UILabel alloc] initWithFrame:CGRectMake(YH_Edges, 0, kScreenWidth-YH_Edges*2, rowHeight)];
        labelTitle.tag = 101;
        labelTitle.backgroundColor = [UIColor whiteColor];
        labelTitle.textColor = kRGBColor(0, 106, 251);
...
- (void)initSubViews{
    ...
    self.tableview = [[UITableView alloc] initWithFrame:CGRectMake(0,kScreenHeight + tableviewH, kScreenWidth, tableviewH) style:UITableViewStylePlain];
    ...
    //2.背景view
    self.backgroundView = [[UIView alloc] initWithFrame:CGRectMake(0, kScreenHeight, kScreenWidth, kScreenHeight)];
    self.backgroundView.backgroundColor = [kRGBColor(195, 196, 197) colorWithAlphaComponent:0.5];
...
- (void)dismissViewAnimation {
    ...
    self.backgroundView.frame = CGRectMake(0, kScreenHeight, kScreenWidth, kScreenHeight);
