...
- (void)showOriImage{
    ...
    tempView.image = [[[EMSDWebImageManager sharedManager] imageCache] imageFromDiskCacheForKey:[self highQualityImageURLForIndex:self.currentImageIndex].absoluteString];
...
- (void)setupImageOfImageViewForIndex:(NSInteger)index
{
    ...
    if ([self hasHighQImage]) {
        imageView.image = [[[EMSDWebImageManager sharedManager] imageCache] imageFromDiskCacheForKey:[self highQualityImageURLForIndex:self.currentImageIndex].absoluteString];
    }
    else{
